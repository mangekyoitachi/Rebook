        ...
        <div className="w-full h-auto flex flex-row">
            ...
            <div className="h-auto relative flex flex-row justify-center items-start w-[40%]">
                <div className="flex flex-col w-full h-auto">
                    ...
                    {/* --- TOP --- */}
                    <div className="flex flow-row justify-between h-auto mt-8 rounded-xl shadow-md  bg-white">
                        {/* --- IMG 2 --- */}
                            <img
                                src={Img2}
                                alt="technology"
                    ...
                    {/* --- BOT --- */}
                    <div className="flex flex-col justify-between items-center h-auto rounded-xl shadow-md  bg-white">

                        {/* --- TEXT 1 --- */}
                        <div className="bg-red-800 w-full text-white font-bold">
                            <p className="text-5xl tracking-normal text-right pb-2">Backpacks & Mini Bags</p>
                        </div>
